...
class JMainPhotoPickerCell : JBaseTableViewCell {
    ...
    override func funj_addBaseTableSubView() {
        ...
        m_titleLabel = UILabel(i: CGRect(x:m_imageView!.right + 20 , y: m_imageView!.center.y - 10, width: KWidth - m_imageView!.width - 40, height: 20), title: "", textFC: JTextFC(f: FONT_SIZE17, c: COLOR_TEXT_BLACK))
